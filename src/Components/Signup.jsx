...
export default function Signup() {
    ...
    const {setLoginModal, endpointHead, setAlertState, setAlert} = useContext(ShopContext);
    ...
    const handleSubmit = async (e) => {
      ...
      try {
        const response = await axios.post(`${endpointHead}/signup`, {
          email: email,
          password: password,
        });
  ...
  return (
    <>
        <form onSubmit={(e) => handleSubmit(e)}>
            ...
            <div className="user-box">
            <input required="" value={password} onChange={(e) => handlePassword(e)} type="password" className={passworderr && "border-b border-red-500 .!border-red-500-important"} />
