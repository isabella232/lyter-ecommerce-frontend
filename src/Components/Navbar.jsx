...
export default function Navbar({ isMobileMenuOpen, setIsMobileMenuOpen, toggleMobileMenu }) {
  ...
  const menu = [
    ...
    { name: 'Cleaning Supplies', Icon: 'cleaning-products.png', linkTo:'/cleaning-supplies' },
    { name: 'Personal Care', Icon: 'personal-hygiene.png', linkTo:'/personal-care' },
                ...
                menu.map((data, index) => (
                  <Link to={data.linkTo} key={index}>
                    <div className="flex flex-col gap-[5px] text-center items-center cursor-pointer" >
                      <img className="category-img w-[30%] h-auto" src={data.Icon}  />
